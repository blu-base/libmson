...
/** @brief Prescribed list symbols
 *
 * Enum according to [MS-ONE] section 2.3.58
 */
...
/** @class ListMSAAIndex
 *  @brief Specifies which list symbol is to be used
 *
 *  represents the simple type according to [MS-ONE] section 2.3.58
 *
 *
 */

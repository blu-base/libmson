...
void LCID::setLCID(const LanguageID& lid) { this->lid = lid; }

LanguageID LCID::getLCID() const { return lid; }


void LCID::setSortID(const quint8 sid) { sortid = sid; }

quint8 LCID::getSortID() const { return sortid; }
...
QString LCID::languageIDtoString() const
{
  return LCID::languageIDtoString(lid);
}


QString LCID::languageIDtoString(const LanguageID& l_id)
{
  switch (l_id) {
  case LanguageID::ar:
    return "ar";

...
/** @brief Prescribed Shapes for Tags
 *
 * Enum according to [MS-ONE] section 2.3.86 for presribed tag shapes
 */
...
/** @class NoteTagShape
 *  @brief Holds a single NoteTagShapeID value
 *

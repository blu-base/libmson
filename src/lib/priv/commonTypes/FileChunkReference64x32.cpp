...
FileChunkReference64x32::FileChunkReference64x32(
    const quint64& stp, const quint32& cb)
...
FileChunkReference64x32::FileChunkReference64x32(FCR_INIT inittype)
    : FileChunkReference64x32()
{
  switch (inittype) {
  case FCR_INIT::NIL:
...
quint64 FileChunkReference64x32::getSizeInFile() { return sizeInFile; }

// void FileChunkReference64x32::writeLowLevelXml(QXmlStreamWriter &xmlWriter)
// const {
